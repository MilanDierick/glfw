...
static GLFWbool loadLibraries(void)
{
	...
	_glfw.win32.user32.SetProcessDPIAware_ = (PFN_SetProcessDPIAware)GetProcAddress(
	...
	_glfw.win32.user32.SetProcessDpiAwarenessContext_ = (PFN_SetProcessDpiAwarenessContext)GetProcAddress(
		_glfw.win32.user32.instance,
	...
	if (_glfw.win32.dwmapi.instance)
	{
		...
		_glfw.win32.dwmapi.GetColorizationColor = (PFN_DwmGetColorizationColor)GetProcAddress(
			_glfw.win32.dwmapi.instance,
...
void _glfwUpdateKeyNamesWin32(void)
{
	...
	for (key = GLFW_KEY_SPACE; key <= GLFW_KEY_LAST; key++)
	{
		...
		else vk = MapVirtualKey(scancode, MAPVK_VSC_TO_VK);

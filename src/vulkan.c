...
GLFWbool _glfwInitVulkan(int mode)
{
	...
	_glfw.vk.EnumerateInstanceExtensionProperties = (PFN_vkEnumerateInstanceExtensionProperties)vkGetInstanceProcAddr(
		NULL,
	...
	for (i = 0; i < count; i++)
	{
		...
		else if (strcmp(ep[i].extensionName, "VK_KHR_win32_surface") == 0) _glfw.vk.KHR_win32_surface = GLFW_TRUE;
		#elif defined(_GLFW_COCOA)
...
const char* _glfwGetVulkanResultString(VkResult result)
{
	switch (result)
	{
		...
		case VK_ERROR_INITIALIZATION_FAILED: return
